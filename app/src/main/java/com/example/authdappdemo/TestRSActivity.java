...
public class TestRSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_rsa);
        bindViews();
        setListener();
    }
    ...
    private void setMyTest(){
        findViewById(R.id.btn_custom).setOnClickListener(v->{
            try{
                String data = edText.getText().toString().trim();
                String afterEncrypt = RSAUtils.encrypt(PRIVATE_KEY, data);
                String decryptStr =RSAUtils.decrypt(PUCLIC_KEY, afterEncrypt);
                Toast.makeText(TestRSActivity.this, decryptStr, Toast.LENGTH_LONG).show();
            }catch (Exception e){
                e.printStackTrace();
            }
        });
...
//                content = "143SDFFSFSDFS423";
        ...
        rsaBtnJiami.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getContent();
                Toast.makeText(TestRSActivity.this, "RSA加密", Toast.LENGTH_SHORT).show();
                /**加密内容*/
                try {
...
//                    String afterencrypt = Base64Utils.encode(encryptByte);
        ...
        rsaBtnJiemi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getContent();
                Toast.makeText(TestRSActivity.this, "RSA解密", Toast.LENGTH_SHORT).show();
...
//                    String decryptStr = new String(decryptByte);
        ...
        base64BtnJiami.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getContent();
                Toast.makeText(TestRSActivity.this, "Base64加密", Toast.LENGTH_SHORT).show();
        ...
        base64BtnJiemi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getContent();
                Toast.makeText(TestRSActivity.this, "Base64解密", Toast.LENGTH_SHORT).show();
